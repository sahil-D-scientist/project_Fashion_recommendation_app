...
if uploaded_file is not None:
    if save_uploaded_file(uploaded_file):
        ...
        st.text("")
        st.text("")
        st.write('<p style="font-size:20px; font-weight:bold;">Recommendations:</p>', unsafe_allow_html=True)        
        st.text("")
        st.text("")
        ...
        with col1:
            st.image(filenames[indices[0][0]], width=150)  # Adjust width as per your requirement
        with col2:
